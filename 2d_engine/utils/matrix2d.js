 ...
 *
 * @param {CanvasRenderingContext2D} [context] - Optional context to sync with Matrix2d
...
export default function Matrix2d(a,b,c,d,e,f) {
...
Matrix2d.prototype = {
	 ...
	 * Context from parent matrix is not applied to the returned matrix.
	 *
	 * @param {Matrix2d} m2 - the matrix to interpolate with.
	 * @param {number} t - interpolation [0.0, 1.0]
	 * @returns {Matrix2d} - new instance with the interpolated result
	 */
	 ...
	 * @param {Matrix2d} m - matrix to compare this matrix with
	 * @returns {boolean}
	 */
	isEqual: function(m) {
	...
	draw: function(p5) {
		...
		vX.draw(p5,p,[255,0,0])
		vY.draw(p5,p,[0,255,0])
